        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="profile.php" class="active">Profile <img src="../../assets/user/images/profile-header.jpg" alt=""></a></li>
            </ul>
        ...
        <div class="page-content">
            ...
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  ...
                  <div class="col-lg-4 align-self-center">
                    <ul>
                      <li>Peliculas reservadas <span>3</span></li>
                    ...
                    <div class="clips">
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                          <div class="item">
                            <div class="thumb">
                              <img src="../../assets/user/images/clip-01.jpg" alt="" style="border-radius: 23px;">
                        ...
                        <div class="col-lg-3 col-sm-6">
                          <div class="item">
                            <div class="thumb">
                              <img src="../../assets/user/images/clip-02.jpg" alt="" style="border-radius: 23px;">
                              <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i class="fa fa-play"></i></a>
                            </div>
                            <div class="down-content">
                              <h4>Second Clip</h4>
                        ...
                        <div class="col-lg-3 col-sm-6">
                          <div class="item">
                            <div class="thumb">
                              <img src="../../assets/user/images/clip-03.jpg" alt="" style="border-radius: 23px;">
                              <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i class="fa fa-play"></i></a>
                            </div>
                            <div class="down-content">
                              <h4>Third Clip</h4>
                        ...
                        <div class="col-lg-3 col-sm-6">
                          <div class="item">
                            <div class="thumb">
                              <img src="../../assets/user/images/clip-04.jpg" alt="" style="border-radius: 23px;">
                              <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i class="fa fa-play"></i></a>
                            </div>
                            <div class="down-content">
                              <h4>Fourth Clip</h4>
          ...
          <!-- <div class="gaming-library profile-library">
            <div class="col-lg-12">
              ...
              <div class="item">
                <ul>
                  <li><img src="../../assets/user/images/game-01.jpg" alt="" class="templatemo-item"></li>
                  <li>
              ...
              <div class="item">
                <ul>
                  <li><img src="../../assets/user/images/game-02.jpg" alt="" class="templatemo-item"></li>
                  <li>
              ...
              <div class="item last-item">
                <ul>
                  <li><img src="../../assets/user/images/game-03.jpg" alt="" class="templatemo-item"></li>
                  <li>
