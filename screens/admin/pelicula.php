...
<body onload="BuscarTodosPelicula();">
    ...
    <div class="content">
      ...
      <div class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="sinopsis" placeholder="Password" />
                <label for="floatingPassword">Sinopsis</label>
              </div>
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="idioma" placeholder="Password" />
                <label for="floatingPassword">Idioma</label>
              </div>

              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="tipo" placeholder="Password" />
