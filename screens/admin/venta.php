            ...
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item text-center">
                  <img class="img-fluid rounded-circle mx-auto mb-4" src="../../assets/admin/img/testimonial-1.jpg" style="width: 100px; height: 100px" />
                ...
                <div class="testimonial-item text-center">
                  <img class="img-fluid rounded-circle mx-auto mb-4" src="../../assets/admin/img/testimonial-2.jpg" style="width: 100px; height: 100px" />
                  <h5 class="mb-1">Client Name</h5>
                  <p>Profession</p>
                  <p class="mb-0">
                    Dolor et eos labore, stet justo sed est sed. Diam sed sed
