        ...
        <div class="row g-4">
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="m-n2">
                ...
                <button type="button" class="btn btn-outline-link m-2">
                  Link
                </button>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="m-n2">
                ...
                <button type="button" class="btn btn-light rounded-pill m-2">
                  Light
                </button>
                <button type="button" class="btn btn-dark rounded-pill m-2">
                  Dark
                </button>
                <button type="button" class="btn btn-link rounded-pill m-2">
                  Link
                </button>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="m-n2">
                ...
                <button type="button" class="btn btn-lg btn-secondary m-2">
                  Large Button (btn-lg)
                </button>
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="m-n2">
                ...
                <button type="button" class="btn btn-square btn-outline-secondary m-2">
                  <i class="fa fa-home"></i>
                </button>
                ...
                <button type="button" class="btn btn-square btn-outline-dark m-2">
                  <i class="fa fa-home"></i>
                </button>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="m-n2">
                <button type="button" class="btn btn-lg btn-lg-square btn-primary m-2">
                  <i class="fa fa-home"></i>
                </button>
                ...
                <button type="button" class="btn btn-sm btn-sm-square btn-primary m-2">
                  <i class="fa fa-home"></i>
                </button>
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
              ...
              <div class="m-n2">
                <button class="btn btn-primary w-100 m-2" type="button">
                  Button
                </button>
